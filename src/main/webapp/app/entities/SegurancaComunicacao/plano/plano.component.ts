...
export class PlanoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.planoService
      ...
      .subscribe(
        (res: HttpResponse<IPlano[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPlanos(): void {
    this.eventSubscriber = this.eventManager.subscribe('planoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPlano[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
